...
// tooltips
Calendar._TT = {};
Calendar._TT["INFO"] = "Informacion";

Calendar._TT["ABOUT"] =
"\n\n" +
"Seleccionar Fecha:\n" +
"- Usa los botnoes \xab, \xbb para seleccionar el año\n" +
"- Usa los " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " botones para seleccionar el mes\n" +
"- Mantenga pulsado el botón del ratón sobre cualquiera de los botones para una selección rápida.";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
"selección de tiempo:\n" +
"-Haga clic en cualquiera de las partes de la hora para aumentarlo\n" +
"- o Mayús-clic para disminuirlo\n" +
"- o haga clic y arrastre para seleccionar más rápido.";
...
Calendar._TT["NEXT_YEAR"] = "Proximo Año";
Calendar._TT["SEL_DATE"] = "Selecionar fecha";
Calendar._TT["DRAG_TO_MOVE"] = "¡Arrastrame!";
